...
import me.voler.classical.ticket.train.Status;
            ...
            if (status.getFlag().equals("true")) {
                ...
                if (eArray.size() > 0) {
                    ...
                    for (Element e : eArray) {
                        station_train_code_element = e.element("station_train_code");
                        from_station_telecode_element = e.element("from_station_telecode");
                        from_station_name_element = e.element("from_station_name");
                        to_station_telecode_element = e.element("to_station_telecode");
                        ...
                        train.setStation_train_code(station_train_code_element.getText());
                        train.setFrom_station_name(from_station_name_element.getText());
                        train.setTo_station_name(to_station_name_element.getText());
                        train.setFrom_station_telecode(from_station_telecode_element.getText());
                        train.setTo_station_telecode(to_station_telecode_element.getText());
